        ...
        function initProgressBars() {
            ...
            progressFills.forEach(fill => {
                // Get the desired width from the data attribute
                const width = fill.getAttribute('data-width');
                
                // Set the width after a short delay for animation
                setTimeout(() => {
        ...
        function initSearch() {
            ...
            function performSearch() {
                ...
                cards.forEach(card => {
                    const name = card.querySelector('.influencer-info h3').textContent.toLowerCase();
        ...
        function initScrollAnimations() {
            const animatedElements = document.querySelectorAll('.section-title, .pricing-card, .cta-section h2, .cta-section p');
